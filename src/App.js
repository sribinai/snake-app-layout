...
class App extends Component {
  ...
  up = () => {
    if(this.state.boxNumber-16<0)
    {
      ...
      this.setState({
        boxNumber: this.state.boxNumber - 16,
      });
    }
  ...
  down = () => {
    if(this.state.boxNumber+16>255)
    {
      this.setState({
        boxNumber: this.state.boxNumber,
      });
  ...
  render() {
    ...
    return (
      ...
      <div class="app">
        ...
        <div class="buttons">
        <input type="button" value="Up" onClick={(e) => {
                this.up();}} ></input>
        <input type="button" value="Down" onClick={(e) => {
                this.down();}}></input>
        <input type="button" value="Left" onClick={(e) => {
                this.left();}}></input>
        <input type="button" value="Right" onClick={(e) => {
                this.right();}}></input>
        </div>
